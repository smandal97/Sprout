...
/* These are useful for situations involving mirror symmetry about a face, e.g.,
   a 1D explosion with planar symmetry (but solved in 2/3D). For the direction of
   motion, the left hand boundaries incorporate a Neumann BC with zero derivative
   with the additional condition that the velocity component of the concerned 
   dimension be mirrored in the ghost zones. The right hand side boundaries use a
   Dirichlet BC. For transverse directions, both sides use a periodic BC. */
