...
void readdata( char * filename , struct domain * theDomain ){
   ...
   theDomain->cart_data = (double *)malloc( Ndoub*Nx*Ny*Nz*sizeof(double) );
   ...
   readPatch( filename , group2 , "Cells" , theDomain->cart_data , H5T_NATIVE_DOUBLE , 4 , start , loc_size , glo_size );
